...
ALTER TABLE album DROP CONSTRAINT album_fk_release_group;
...
ALTER TABLE isrc DROP CONSTRAINT fk_isrc_track;
...
ALTER TABLE release_group DROP CONSTRAINT release_group_fk_artist;
ALTER TABLE release_group_meta DROP CONSTRAINT release_group_meta_fk_id;
ALTER TABLE release_groupwords DROP CONSTRAINT release_groupwords_fk_release_groupid;
